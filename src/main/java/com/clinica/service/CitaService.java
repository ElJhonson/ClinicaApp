...
public class CitaService {
    ...
    public CitaService(PsicologoRepository psicologoRepo, PacienteRepository pacienteRepo, UserRepository userRepo, SecreRepository secreRepository, CitaRepository citaRepository) {
    ...
    public CitaResponseDTO actCita(int id, CitaRequestDTO dto) {
        ...
        Psicologo psicologo = psicologoRepo.findById(dto.getPsicologoId())
                .orElseThrow(()-> new PsicologoNotFoundException("Psicologo no encontrado"));
